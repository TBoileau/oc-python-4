...
## Issues
[Issues](https://github.com/TBoileau/oc-python-4/issues) est le canal idéal pour les rapports de bug, les nouvelles fonctionnalités ou pour soumètre une `pull requests`, cependant veuillez a bien respecter les restrictions suivantes :
...
1. Clonez le repository :
    ```
    git clone https://github.com/TBoileau/oc-python-4
    ```
